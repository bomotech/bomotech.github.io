...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_uniqueTriggerId": "10572041_9",
                "tag_id": 38
            }, {
                "function": "__tl",
                ...
                "vtp_interval": "120000",
                "vtp_limit": "1",
                "vtp_uniqueTriggerId": "10572041_18",
                "tag_id": 39
            }, {
                "function": "__lcl",
                "vtp_waitForTags": false,
                "vtp_checkValidation": false,
                "vtp_waitForTagsTimeout": "2000",
                "vtp_uniqueTriggerId": "10572041_29",
                "tag_id": 40
            }],
            "predicates": [{
                "function": "_eq",
                ...
                "function": "_cn",
                "arg0": ["macro", 3],
                "arg1": "https:\/\/blogonyourown.com\/recommended\/"
            }, {
                "function": "_re",
                "arg0": ["macro", 2],
                "arg1": "(^$|((^|,)10572041_29($|,)))"
    ...
    */
    ...
    J.yd = "ba1";
    J.W = "dataLayer";
    J.Eh = "ChAIgOL3jAYQjr3U/LexmpknEiQAsidgvwKZ+otWGNV+Cumg55yyA7xQjy+agA9axXboVOy+wOoaAqGY";
    var Xg = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var ah = $g,
        ...
        ch = null,
        dh = null,
        eh = "https://www.googletagmanager.com/a?id=" + J.J + "&cv=28",
        fh = {},
        gh = {},
        hh = function() {
            var a = Vg.sequence || 1;
    ...
    Y.h.tl = ["google"],
        function() {
            function a(b) {
                return function() {
                    if (b.nf && b.qf >= b.nf) b.ff && V("self").clearInterval(b.ff);
                    else {
                        b.qf++;
                        var c = et().getTime();
                        jt({
                            event: b.eventName,
                            "gtm.timerId": b.ff,
                            "gtm.timerEventNumber": b.qf,
                            "gtm.timerInterval": b.interval,
                            "gtm.timerLimit": b.nf,
                            "gtm.timerStartTime": b.nh,
                            "gtm.timerCurrentTime": c,
                            "gtm.timerElapsedTime": c - b.nh,
                            "gtm.triggers": b.bk
                        })
                    }
                }
                ...
                if (!isNaN(b.vtp_interval)) {
                    var c = {
                        ...
                        nf: isNaN(b.vtp_limit) ? 0 : Number(b.vtp_limit),
                        bk: String(b.vtp_uniqueTriggerId || "0"),
                        nh: et().getTime()
                    };
                    c.ff = V("self").setInterval(a(c), 0 > Number(b.vtp_interval) ? 0 : Number(b.vtp_interval))
                }
            })
        }();
    Y.h.ua = ["google"],
